                        ...
                        >
                            <VStack space={4}>
                                ...
                                <Input
                                    ...
                                    InputRightElement={
                                        <Pressable onPress={() => setShowSenha(!showSenha)} pr={3}>
                                            <Icon
                                                as={<MaterialIcons name={showSenha ? "visibility" : "visibility-off"} />}
                                                size={5}
                                            />
                                        </Pressable>
                                    }
                                ...
                                <Input
                                    ...
                                    InputRightElement={
                                        <Pressable onPress={() => setShowConfirmarSenha(!showConfirmarSenha)} pr={3}>
                                            <Icon
                                                as={<MaterialIcons name={showConfirmarSenha ? "visibility" : "visibility-off"} />}
                                                size={5}
                                            />
                                        </Pressable>
                                    }
                                ...
                                <Center mt={3}>
                                    <Text fontSize="sm" color="coolGray.700">
                                        Já tem conta?{" "}
                                        <Link _text={{ color: "primary.700", fontWeight: "bold",  textDecorationLine: "none" }}>
                                            Login
                                        </Link>
                                    </Text>
                                </Center>
